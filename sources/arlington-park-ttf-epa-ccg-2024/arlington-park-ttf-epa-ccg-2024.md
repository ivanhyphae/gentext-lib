---
asset_id: arlington-park-ttf-epa-ccg-2024
source_system: gdrive
source_id: 1OiSWgEBztfUW2qnpvzyOSrqr03S-ps4Oh8VqknFBgcY
source_title: "Arlington Park_TTF_Texas A&M_EPA Grant_hyphae"
acquired: 2026-09-25
via: connector-text
...
Use the tabs at left (\[image\]) to navigate the material
...
<comment_start id=kix.32mjchk4r1j5>Hyphae will support TAMU staff in structuring and implementing the community engagement tasks, as well as on capacity building and training tasks as technical assistants. Hyphae will contribute experience in community engagement as well as documentation of outcomes. Hyphae staff will also install and train TAMU students and community members in installation, maintenance, and data collection for sensors.
...
Hyphae designers will assist in co-design process with community members through a series of charrettes culminating in conceptual drawings of proposed designs. They will generate plans, sections, and perspectives as appropriate to communicate the primary outcomes of the design sessions. A master plan level illustrative drawing will be made public to show the connectivity and place-based interventions proposed for both limited tactical interventions and longer term civic scale upgrades for neighborhood resilience.<comment_end id=kix.32mjchk4r1j5>
## **Budget**
...
Evidence based, <comment_start id=kix.bo8q0ykdtku>Community participatory design process requires a principal, project manager, and Arborist, Community Forestry expert to travel to the neighborhood on multiple occasions<comment_end id=kix.bo8q0ykdtku> as well as manage the project in collaboration with TAMU and TTF throughout the life of the project.
*Task Items:*
...
# <comment_start id=kix.8u0cy3j7c952>PREVIOUS MATERIAL<comment_end id=kix.8u0cy3j7c952>
...
## Hyphae Materials
<comment_start id=kix.ch350pr9sse0>[adapt OS narrative](https://docs.google.com/document/d/1TOP8NqhALUf3fTVfasGWsmJr4qM-Z933kueTwj7LqRc/edit?usp=sharing)<comment_end id=kix.ch350pr9sse0>
...
These Categories are addressed in each of the two budget subcategories
  ...
  - 
# AirSense grant
<comment_start id=kix.bakr2i12sr3e>From EPA AQ w/ Andres
Community Engagement Plan<comment_end id=kix.bakr2i12sr3e>
Introduction
...
\[add language on pedestrian mobility\]
...
## **<comment_start id=kix.yr35objla43c>Future Phases Post 30% Engagement **\[NOT IN PRESENT BUDGET\]<comment_end id=kix.yr35objla43c>
...
# Arlington Park\_TTF\_Texas A\&M\_EPA Grant
RFP: 
[Environmental and Climate Justice Community Change Grants Program Notice of Funding Opportunity (NOFO) October 3 2024](https://www.epa.gov/system/files/documents/2024-10/environmental-and-climate-justice-community-change-grants-program-notice-of-funding-opportunity-nofo-october-3-2024.pdf)
# MEETINGS
## Nov 19, 2024 | [FW: TTF EPA EJ grant check in](https://www.google.com/calendar/event?eid=N3RibHM4bzJpcmdpOW5qaWdrdnVoMDVudDRfMjAyNDExMTlUMjEwMDAwWiBpdmFuQGh5cGhhZS5uZXQ)
Attendees: 
Do several projects, ceiling $250k for federal procurement requirements
#### **Key Points Discussed:**
1.  **Document and Attachments Coordination:**
      - Team members are working on the main document and attachments.
      - Specific formatting requirements were mentioned, especially ensuring alignment between questions in the main narrative and attachments.
2.  **Tasks Delegation:**
      - Section A of the document, which includes general details like CEO information, was assigned for review.
      - Work on integrating feedback and ensuring correctness in attachments and main document is ongoing.
3.  **Budget Planning:**
      - Extensive discussion on aligning budget items, including interventions, community engagement costs, and sensor deployment.
      - The importance of keeping certain projects below federal procurement limits to avoid complex processes was highlighted.
      - Allocation of $1 million for community interventions and discussion on unit pricing for trees and other elements.
4.  **Community and Environmental Engagement:**
      - Emphasis on community-based planning, including tree planting informed by master plans or previous projects.
      - Engagement with residents of Arlington Park was noted, including scheduled meetings to discuss the project.
5.  **Sensor Deployment and Leasing:**
      - Details about leasing environmental sensors to avoid federal ownership complications were outlined.
      - Maintenance costs for sensors were estimated, with potential sharing of technology resources.
6.  **Construction Planning:**
      - Tentative timeline for construction to begin around August 2026, with procurement expected in the first year.
      - Adjustments to schedules and budgets based on project phases were discussed.
7.  **Milestones and Goals:**
      - Discussion about integrating "go/no-go" milestones into the project schedule.
      - Flexibility in task schedules, considering seasonal and operational constraints like school years and weather.
8.  **Technical Adjustments and Team Contributions:**
      - Refinements in budget justifications, data storage costs, and allocations for team members.
      - Tasks and contributions from Texas A\&M and other partners were clarified to avoid redundancy.
9.  **Finalization and Deadlines:**
      - The goal is to complete all documentation and budget revisions by tomorrow, allowing submission by the deadline.
      - The main document is being finalized by integrating the completed attachments.
#### **Action Items:**
1.  Review and refine the budget allocation across tasks and categories.
2.  Adjust the project schedule based on finalized timelines and milestones.
3.  Complete feedback and finalize attachments for integration into the main document.
4.  Conduct a community meeting in Arlington Park to gather input and share updates.
## Nov 18, 2024 | [SWMD | EPA Community Change Grant](https://www.google.com/calendar/event?eid=)
Attendees: [Ivan Heitmann](mailto:ivan@hyphae.net) [Brent Bucknum](mailto:brent@hyphae.net) [Lee, Chanam](mailto:chanam@tamu.edu) [David Whitley](mailto:david@drwplanning.com) [Abby McGee](mailto:abby@texastrees.org) [Lannie McClelen](mailto:lannie@texastrees.org) [Laura Burnham](mailto:lburnham@brsinc.com)
Notes
  - hyphae review calendar/schedule from Laura
  - laura focusing on getting all attachments complete and then the main narrative doc is a summary of everything else
  - Laura waiting for a workplan from Chanam
  - chanam supposedly waiting for a budget to plug in to finalize their 
Action items
- [ ] make sure attachments on google docs are correct and go ahead and edit
## Nov 14, 2024 | [EPA Meeting ](https://www.google.com/calendar/event?eid=)
Attendees: [Ivan Heitmann](mailto:ivan@hyphae.net) [Hughes, Brady](mailto:bhughes@tamu.edu) [Brent Bucknum](mailto:brent@hyphae.net) [Lee, Chanam](mailto:chanam@tamu.edu) [Salkhi Khasraghi, Gisou](mailto:gisou.salkhi@tamu.edu) [Hanwool Lee](mailto:list1205@gmail.com) [Chen, Xi](mailto:xchen@arch.tamu.edu)
Notes
  - We have budgets to do EBD through the rest of the design process as well as a post-install
  - Could fund analysis follow-ups
  - Ivan should work on budgets for corridor work
  - Brent can work tonight on first pass of budget for Arlington Park
  - Pull our text on what is our evidence based design process
  - 1-page doc for Measure - modify - get from Brent
  - Big chunk to arlington big chunk to EBD in GS so need to include text from spine 
  - **1st** Boyle heights scope is good for community process
*Chanam joins*
  - <comment_start id=kix.kwkp1cl0k199>Brent’s ideas
      - Master plan
      - Getting Arlington people to and from the park
      - extend thermal sensor network into neighborhood
      - occupancy: add pedestrian / biking sensors, data analysis goes to TAMU grad student?<comment_end id=kix.kwkp1cl0k199>
  - Chanam
      - grant is supposed to go to disadvantaged community - does medical district qualify?
      - green connectors and green shelters
      - temporary, mock-up, pop-up interventions
      - 3-yr is a short timeline for intervention
      - capacity building
      - place based or activity based analysis or individual health
  - How much is soft cost? vs. interventions
  - Year over year
      - 1- Community engagement and diagnostics, co-design
      - 2 - interventions - TTF
      - 3 - impact assessment
  - AQ?
Action items
- [x] Include our previous budgets for DD phase of evidence work on the corridor
- [x] Dig up Harry Hines EBD proposal text and copy into Arlington “Stuff from other projects”
## 11/14/24 MP-IH
Action Items:
- [x] MP push for Brent/Chanam EPA grant meeting (IH confirms this is in motion)
## <comment_start id=kix.6jha50ufa0jm>11/13/24 IH-MP<comment_end id=kix.6jha50ufa0jm>
-----
Topic: EPA TTF Community Change Grant (w/ Texas A\&M) 
-----
*Context *
Context was that TTF was applying as Lead w/out a CBO involved, 
*Update*
IH attended the meeting and was reassured that though Texas Trees Foundation (TTF) is set to lead as the nonprofit applicant for the EPA Dallas grant, they are not ignoring community voices. They are pursuing letters of support (LoS) from Arlington Park (AP) community groups, various municipal governments, and other relevant organizations.
David from TTF, a Project Management (PM) consultant, acted as TTF representative in the meeting. Lannie was present but did not provide input.
Tone from TTF: Ivan noted that TTF didn’t appear to be exerting excessive control over the process; instead, they seemed receptive to Hyphae’s emphasis on a project that benefits the AP community.
*Community Engagement Priority *
There was strong emphasis from both Chanam and the grant writer, Laura, on prioritizing measurable outcomes for the Arlington Park community, and having it be a community-led process. 
Her advice is informed by preliminary feedback from EPA encouraging a focus on concrete outcomes rather than just subjecting the community to yet another study with nothing to show for it.
  - 
Laura and Chanam are aligned with Brent’s objective of focusing on connectivity and urban mobility, prioritizing these over other exploratory aspects like additional monitoring or modeling.
They expressed alignment with Brent’s priorities, but no detailed plan was set yet for community engagement specifics.
Exact outline of community engagement is in Chanam’s court. The current task is to determine a framework that defines the community engagement strategy, even if the exact interventions can remain TBD.
*Scope of Work*
Laura is going to write this grant over the weekend. To write and submit, however, she requires a clear scope of work from Hyphae. 
  - (Is Hyphae scope still estimated at $750k?)
Laura stressed the importance of establishing at least a framework for community-led design interventions even if many details remain TBD.
Laura was also sensitive to the 3-year timeline not being a very long time.
Action Items: 
- [x] Chanam and Brent were supposed to talk Thursday morning to finalize an approach for Hyphae’s proposed scope of work. 
- [x] Ivan hopes to join that Thursday meeting, write the scope, and provide some text to Laura for the narrative by EOD Thursday
- [x] Brent will review on Friday and submit (Laura is on East Coast and would start integrating our material Sat morning)
- [x] MP pull the existing material from Dallas (Greenspine), Boyle Heights, and Ambrose Project and tagging Ivan (see material below, [Ivan Heitmann](mailto:ivan@hyphae.net))    
## Nov 12, 2024 | [FW: TTF EPA EJ grant check in](https://www.google.com/calendar/event?eid=N3RibHM4bzJpcmdpOW5qaWdrdnVoMDVudDRfMjAyNDExMTJUMjEwMDAwWiBpdmFuQGh5cGhhZS5uZXQ)
Attendees: 
Notes
  - TTF to be main applicant
  - Laura getting checklist together - [TTF-EPA EJ Proposal Task Tracking](https://docs.google.com/spreadsheets/d/1OIgJ375HKs6TNuNeoexOupYvQ56xsORZ/edit?usp=drive_link&ouid=100907200703231031850&rtpof=true&sd=true) Google sheet
  - Stemmons, m
Action items
- [ ] 
## Nov 12, 2024 | [EPA grant check-in](https://www.google.com/calendar/event?eid=NnR1MmVtajZma2k3Zmk4bHFlam8ycjRxc2sgbWF4QGh5cGhhZS5uZXQ)
Attendees: [Brent Bucknum](mailto:brent@hyphae.net) [Ivan Heitmann](mailto:ivan@hyphae.net) [Maxwell Pingeon](mailto:max@hyphae.net)
Meeting Notes - EPA Grant Check-in (11/12/24)
Attendees: Brent Bucknum (BB), Ivan Heitmann (IH), Maxwell Pingeon (MP)
\#\# Context & Strategic Direction from BB
\#\#\# Project Overview:
\- EPA Community Change Grant ($10M total)
\- Due: November 21st
\- Lead: Texas A\&M University
\- Hyphae sub-award: $750K-1M proposed
\- Structure: Higher Ed (Texas A\&M) + CBO (Texas Trees Foundation)
\#\#\# BB's Core Concerns:
Direct Quote: "I've been slightly frustrated by it. At the same time, I feel like it's worth putting some time in since they're going to submit it and the ideas that we would essentially be working with Texas A\&M, and they would be like the prime contractor."
\#\#\# Community Engagement Issues:
BB's Position: "I don't know if it's even achievable without a community partner personally... Texas trees should not be saying that they can do this. Cause I know from experience that you do a really shitty job of it."
<comment_start id=kix.7ug6sco9xurp>\#\# Existing Materials to Draw From
1\. Boyle Heights EPA Grant:
\- Complete streets analysis
\- Sidewalk improvements
\- Tree planting areas
\- Evidence-based design outreach process
\- Prioritized greening locations
\- Community engagement strategy<comment_end id=kix.7ug6sco9xurp>
2\. Greenspine Project Materials:
\- Air, heat, pollution driven analysis
\- Pedestrian studies
\- BB: "I mean, I think part of it is like, as far as our evidence-based design process, it is saying and or including images of what we did for the Greenspine, right? I can be cynical about it, but it's also pretty innovative."
3\. Ambrose Project (with James/Chris):
\- Creek access improvements
\- Community connectivity analysis
\- BB: "That would be a good one. I didn't even think of that, but yes, it would be."
4\. Dallas Previous Work:
\- Connectivity studies
\- Creek corridor analysis
\- Pedestrian access mapping
\- BB: "I can show you some of the Dallas stuff... we can basically start with like we have budgets to help like do the evidence-based design project management and community design meetings."
\#\# Technical Deliverables Approach
\#\#\# Format Specifications:
BB: "This isn't like a government grant... we can include images probably in like links to shit from Dallas... we could just like include a whole like press attack... GIFs and cool stuff"
\#\#\# Required Elements:
1\. Evidence-based design process documentation
2\. Climate change connection
\- BB: "As long as it can be related to climate change, it probably can. And so I feel like doing tree planting and incentivizing better sidewalks and pedestrian access can be argued easily for climate change"
\#\# Implementation Timeline (3-year grant)
Year 1:
\- Community engagement and design development
\- BB: "Working with the community to do a design of it in a few minutes here... what do they want and where is going to be like a year of the process"
Years 2-3:
\- Pilot projects (creek access, trail improvements)
\- BB: "Any of the actual streets improvements would probably take more time than they have in this grant"
\#\# Action Items & Assignments
Ivan:
1\. Attend 1:00 PM meeting
2\. Block time later this week for text development
3\. BB: "If you're looking at it... I think it seems like most of it's like in our wheelhouse"
Max:
1\. Create new internal Google Doc
2\. Coordinate documentation
3\. Support strategic content development
Brent:
1\. Block morning session for content development
2\. Pull Boyle Heights materials
3\. BB: "Do we on Wednesday or Thursday just block out three or four hours and just write something up?"
\#\# Content Development Strategy
Quick Turnaround Approach (BB's suggestion):
"One of my approaches... was like, okay, we'll take like two hours to meet with Chanam and then we'll spend like four or five writing something up and just give it to them and be like, it's your guy's fucking problem."
\#\#\# Source Material Hierarchy:
1\. Boyle Heights grant as primary template
2\. Greenspine technical documentation
3\. Ambrose project community elements
4\. Dallas previous work visuals
\#\# Process Notes:
\- Need to balance resource investment against timeline
\- Focus on quick, strategic content development
\- Use existing materials where possible
\- Maintain focus on climate change connection
\- Consider proceeding even without strong community partnerships
BB's Final Strategic Direction: "I put the whole Boyle Heights proposal together in like four or five hours... do we do a strategic insertion approach?"
### Live Notes Taken by MP
  - We did an EPA community change grant w/ Boyle Heights 
  - But now Dallas wants to do the same
  - We want to flip the Boyle Heights + \_\_\_\_
  - Overall arc of grant: 
  - Something about a central park being unnecessary
  - Partner decided to go for a last minute EPA Change grant 
  - BB thought effort was insufficiently community-driven
  - Something about the neighboring community 
  - BB accused them of carpetbagging by ID’ing DAC near Greenspine in order to fund Greenspine 
  - Commitment to DAC, Arlington, was not sincere
  - BB sitting in meetings
  - Chanam and Texas A\&M wants to involve health research
  - Has history with working with CBOs
  - Idea is that Hyphae would work with Texas A\&M as a subcontractor 
  - They want to give us $750k to 1 million
  - But for what? 
      - Before we were going to do evidence based design outreach process with Chanam
      - But now how is the budget divided up: is that design money, physical improvements in neighborhood?
          - Two docs are circulation: a sub awardee thing
          - Want us to do similar BH: sidewalk improvements, tree planting areas, and funding what we would want to accomplish in Arlington Park community 
          - Could continue to found our R\&D work with Chanam on corridor
              - BB retort: but if there no CBO partners, cannot apply
              - Was some hesitation, now T A\&M seems to be going for it
          - Priotirize greening
          - Complete streets analysis 
          - AQ monitoring? Deploy equipment?
          - Community wants safer streets, better infrastructure not a whole new park in the medical district 
          - Arlington Park a ‘hood between industrial ‘hoods
          - Backs up right to medical district
          - Creek used to run through it before it was diverted 
          - Sandwiched btween freeway and industrial corridor 
          - BB: do we look at buffering them from shipping facility 
          - Idea is that grant will fund corridor work 
          - Some tree planting in arlington park 
          - But also for us and Chanam to come upo with design options
          - Planning monitoring and modeling for the arlington park nbeighborhood 
          - Community can’t even cross the road 
          - And they don;t care about the proposed new central park that is also inaccessible 
          - Pathway, access analysis, tree cover analysis 
          - We have already located where there are no sidewalk, new creek trails, getting community out to the creek
          - More crosswalks 
          - Applicants don;t have buy-in form arlington park neighborhohgod association yet 
          - Abby and Lannie and David from TTF were scrambling to get them to sign on 
          - Won;t be competitive without them on board 
          - Were going to meet last week but unclear if they secured buy-in 
          - How do we use creeks as circulation corridor 
          - How do we use connectivity 
          - Grant needs to address “climate change” guidelines say
          - BB suggests a study of community and paying for some of the tree planting and initial trail work 
          - But streetscape improve,enmts will take more time than the grant timeline allows (3 year grasnt)
              - 1 yr working with community to do a design (what do they want and where)
                  - Don;t have an organiozed community so it will be capacity building also 
              - Sidewalk improvements, design and coordaintion with city will take a while (not feasible in total three year period)
              - Big part ogf Constructioon money will go to corridor while alos funding our community resilience and access study and extending monitoring and evaluation out to the arlington park area
              - We write up that we will work with CBOP adn TAM to do evidence based design 
              - But they will want to see physical imopriovements that we can commit to providing 
              - What would be an easy win: creek access, or trail entry points, ton have some pilot projects
                  - Permitting the sideqaslk improvements will take time 
                  - But maybe some of the creek access will eb more achievable 
                  - Are parts of the neighborhoods connectable rather than crossing the highway, especially to the new park 
                  - No sidewalks or crosswalks 
                  - What ius connectivity between UT SWestern land near the corridor and the community 
              - IH asked if upcoming meeting will be about how money will be spent 
                  - IH to recap: do we need to follow up with them about interfacing with the CBO
              - BB also could work with other community cap\[acity building groupos in Dallas 
                  - TTF should not be saying that they can do it (needs black and brown representation)
                  - Chanam added experience with CBOs in other parts of the country (understand approach but doesn't have the contacts)
                  - T A\&M go another grant from the EPA w/out CBO partners 
                  - WE can;t solve everything in the one meeting 
                  - But what are design interventionss possibly 
                  - Meet with Chanam and David Whitley on this subject? 
                      - Plan for later in work 
                  - Do we alos meet with Chanam over wehat is our R\&D evidence based design (EBD)
                  - Maybe approach is 2 hours meeting with Chanam and then write up something for 4 hours and hand it off 
                  - Block off 3 or 4 hours on Wednesday and hand off 
                  - TTF is supposedly the CBO lead 
                      - TTF has a grantwriter for hire for whom we need to provide content
                      - Aka Rewrite BH + other projects 
                          - James Ambrose Project e.g.
                          - INcluding images of Greenspine 
              - IH maxed out capacity
                  - But can send some text to Laura (TTF?)    
                  - Does BB schedule some time and bang it out
                      - WE can bust out Fresno next week
                          - Include images from Dallas 
                          - Have a whole prez, with images, and GIFs                   
Action items
- [ ] IH to attend 13:00 meeting 
- [ ] IH and BB determine if worth applying and if so send some text to grant writer by Thursday 
- [ ] Pull material from Boyle Heights as well as [James Hansen](mailto:james@hyphae.net) work on Ambrose and other work with Chris Lim


# 1-page Concept-vision (Laura Burnham)

[1-page Concept-vision.docx](https://docs.google.com/document/d/1jJphpU2fgzrUbFl7CX83tHcGXXisbCMY/edit)
TTF/TAMU 
Project Concept for EPA Environmental and Climate Justice Community Change Grant
Track 1
Texas Trees Foundation (TTF) proposes in partnership with Texas A\&M University (TAMU) to increase community resilience through climate action activities for the Southwest Medical District and its neighbor, the community of Arlington Park, including the testing and evaluation of interventions/ guerilla urban tactics that can be expanded to other disadvantaged communities.
The proposed project scope includes:
1.  Transforming the land use of the public right of way along Harry Hines Boulevard, an important transportation corridor with green and blue infrastructure, including rain gardens, tree plantings, native plant/pollinator gardens, stormwater management, trails and bike lanes to mitigate a major heat island and reduce GHG emissions. This element of the project has been named the Green Spine and is Phase 1 of a larger initiative being led by the Texas Trees Foundation and the City of Dallas.
2.  Leverage the C-heart team of TAMU to measure the health and environmental benefits of the Green Spine through extensive community engagement and access to expertise and technical resources to expand these benefits to the adjoining neighborhoods.
3.  To provide analysis and design options for neighborhood climate change resiliency interventions developed with the Arlington Park community that lowers their environmental and health risks, including accessibility barriers to the medical district. Low-cost interventions will be chosen by the community, implemented and evaluated. Tactics found to be helpful will be documented for future application/adaptation in other disadvantaged neighborhoods. A needs assessment of more systemic solutions required will be produced for further action.
Roles
  - TTF – Green Spine implementation
  - TAMU/C-Heart – Community Engagement, Community Intervention-design, implementation, evaluation and documentation; Project metrics- analysis and outcomes, Further Action Neighborhood Environmental Needs Assessment
  - City of Dallas – Coordination with city agencies
  - Arlington Park Neighborhood Association – Community Engagement; liaison
 
Budget - $18,478,024
  - Green Spine Implementation - $15,319,024 (TTF)
  - Community Engagement/interventions - $2,430,000 (TAMU/C-Heart team)
  - Outcomes Analysis - $729,000 (TAMU)
...
[
  {
    "commentId": "AAABYMViI5s",
    "headPost": {
      "authorName": "Ivan Heitmann",
      "content": "@brent@hyphae.net needs work",
      "modifiedTime": "2024-11-18T16:05:43.347Z",
      "postId": "AAABYMViI5s"
    },
    "replies": [
      {
  ...
  {
    "commentId": "AAABYMViI4Y",
    "headPost": {
      "authorName": "Ivan Heitmann",
      "content": "@brent@hyphae.net @max@hyphae.net first pass simple scope of work to go into the greater document by TAMU",
      "modifiedTime": "2024-11-18T17:35:37.904Z",
      "postId": "AAABYMViI4Y"
    },
    "replies": [
      {
  ...
  {
    "commentId": "AAABYMRtF0E",
    "headPost": {
      "authorName": "Brent Bucknum",
      "content": "@ivan@hyphae.net",
      "modifiedTime": "2024-11-15T19:24:35.355Z",
      "postId": "AAABYMRtF0E"
    },
    "status": "OPEN"
  },
  {
    "commentId": "AAABYMRtFzk",
    "headPost": {
      "authorName": "Maxwell Pingeon",
      "content": "@ivan@hyphae.net",
      "modifiedTime": "2024-11-15T19:57:57.414Z",
      "postId": "AAABYMRtFzk"
    },
    "replies": [
      {
  ...
  {
    "commentId": "AAABYMQbArA",
    "headPost": {
      "authorName": "Maxwell Pingeon",
      "content": "@ivan@hyphae.net Ivan I've been adding everything to here",
      "modifiedTime": "2024-11-15T20:12:01.836Z",
      "postId": "AAABYMQbArA"
    },
    "replies": [
      {
  ...
  {
    "commentId": "AAABYI_lECU",
    "headPost": {
      "authorName": "Maxwell Pingeon",
      "content": "@ivan@hyphae.net Here's a list of docs to curate some text blocks for Laura",
      "modifiedTime": "2024-11-15T19:58:00.318Z",
      "postId": "AAABYI_lECU"
    },
    "replies": [
      {
        "authorName": "Ivan Heitmann",
        "content": "@brent@hyphae.net raw text material to use for Arlington Park app",
        "modifiedTime": "2024-11-15T00:47:56.466Z",
        "postId": "AAABYce5Jn4"
      },
      {
        "authorName": "Ivan Heitmann",
  ...
  {
    "commentId": "AAABYMRtFyY",
    "headPost": {
      "authorName": "Brent Bucknum",
      "content": "@ivan@hyphae.net are you moving all this into project specific narrative?",
      "modifiedTime": "2024-11-15T19:08:14.586Z",
      "postId": "AAABYMRtFyY"
    },
    "status": "OPEN"
  },
  {
    "commentId": "AAABYMRtFyM",
    "headPost": {
      "authorName": "Brent Bucknum",
      "content": "are you taking a stab to move this stuff in and combine it with bh stuff to be TTF specific @ivan@hyphae.net",
      "modifiedTime": "2024-11-15T23:08:52.107Z",
      "postId": "AAABYMRtFyM"
    },
    "replies": [
      {
        "authorName": "Ivan Heitmann",
        "content": "i can but i was hoping to have a task list framework before plunging into that task",
        "modifiedTime": "2024-11-15T19:14:50.534Z",
        "postId": "AAABYMRtFzg"
      },
      {
        "authorName": "Ivan Heitmann",
  ...
  {
    "commentId": "AAABYI_lD_A",
    "headPost": {
      "authorName": "Maxwell Pingeon",
      "content": "@Brent@hyphae.net @ivan@hyphae.net Brent, I'm putting this on your calendar to look at but also tagging you here.",
      "modifiedTime": "2024-11-15T19:58:03.002Z",
      "postId": "AAABYI_lD_A"
    },
    "replies": [
      {
