...
| M4/M7 Prose signals | Holistic, span-level signals (generic, slop, grade level, grammar density, off-voice) as percentiles against Hyphae's exemplar corpus; WQRM; quote-validated Claude span annotator; one unified finding record; mostly build (Sapling, Gemini on trial) | adopt / trial | [prose-signals](prose-signals/index.md), [span-feedback-schema](prose-signals/span-feedback-schema.md) |
